...
import css from './LocationAutocompleteInputAirport.css';
...
const DEBOUNCE_WAIT_TIME = 0;
const DEBOUNCE_WAIT_TIME_FOR_SHORT_QUERIES = 0;
...
*/
class LocationAutocompleteInputImplAirport extends Component {
  constructor(props) {
    super(props);
  ...
  selectPrediction(prediction) {
    ...
    var place = this.getGeocoder().getPlaceDetails(prediction); console.log(place);
    /*this.getGeocoder()
...
LocationAutocompleteInputImplAirport.defaultProps = {
  autoFocus: false,
  closeOnBlur: true,
  rootClassName: null,
  className: null,
...
LocationAutocompleteInputImplAirport.propTypes = {
  autoFocus: bool,
  rootClassName: string,
  className: string,
  closeOnBlur: bool,

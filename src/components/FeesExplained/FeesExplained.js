...
<ul>
      <p><li className={css.smallBullet}>
...
<h2>Other Fees:</h2>
<ul><p><li className={css.smallBullet}>Fines for damage: We try to avoid all instances of damage, but in the rare event that damage to the crash pad property, equipment, or other takes place during the time period of the booking, the crew member (user booking) is directly responsible for these fees. As defined in the Terms of Service, the crew member is liable for this damage and FCP may collect this if required. It is encouraged for both the crash pad owner and crew member to work through this directly since it is usually best handled directly. Crash pads are also encouraged and in some instances required to have their own General Liability (GL) insurance policies per our Terms of Service for this very reason. If you need to report damage to your crash pad, equipment, or other at any time, please take the proper action to first contact any local authorities if necessary, your insurance provider, and also notify us immediately at help@findacrashpad.com.
</li></p></ul>

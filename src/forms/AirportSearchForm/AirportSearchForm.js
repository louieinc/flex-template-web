...
import css from './AirportSearchForm.css';

class AirportSearchFormComponent extends Component {
  constructor(props) {
    super(props);
...
AirportSearchFormComponent.defaultProps = {
  rootClassName: null,
  className: null,
...
AirportSearchFormComponent.propTypes = {
...
const AirportSearchForm = injectIntl(AirportSearchFormComponent);
